...
<div className="listItem">
		<MyLink className="float-right ml-5 border drop-shadow-md w-52 bg-slate-50 text-center" href="https://v1.jazzbutcher.com/images/stranger_tractors/Strangers.jpg">These were the Tractors<Image src="https://v1.jazzbutcher.com/images/stranger_tractors/Strangers.jpg" width={250} height={250} alt="strangers" /> Curtis, Mr. Nasty, Bollie, Matt, and Mr. Shouty.  </MyLink>
...
<div className="listItem clear_float">
		<MyLink className="float-right ml-5 border drop-shadow-md w-52 bg-slate-50 text-center" href="https://v1.jazzbutcher.com/images/stranger_tractors/stranger_tractors.jpg"><Image src="https://v1.jazzbutcher.com/images/stranger_tractors/stranger_tractors.jpg" width={250} height={250} alt="album cover" /></MyLink>
...
<p />
		<MyLink className="float-right ml-5 border drop-shadow-md w-52 bg-slate-50 text-center" href="https://v1.jazzbutcher.com/images/stranger_tractors/BEANKING.jpg"><Image src="https://v1.jazzbutcher.com/images/stranger_tractors/BEANKING.jpg" width={250} height={250} alt="the bean king" />{expand('curt')}</MyLink>
