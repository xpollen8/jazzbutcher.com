...
<>
	...
	<main>
		...
		<dl>
			...
			<dd>{expand('davis')} (Yes again)</dd>
			<dd>{expand('go')}</dd>
			<dd><i>September Gurls</i> (Alex Chilton)</dd>
			<dd><i>Waiting For The Love Bus</i> (A one-off.  It went through the mincer and now it&apos;s a {expand('aero')} album track or something.)</dd>
			<dd>{expand('whad')} (New l.p again.  Only a BIT morose)</dd>
			<dd>{expand('sis')} (Yeeeaaaaah)</dd>
			<dd>{expand('odd')}</dd>
			<dd>{expand('ben')} (New lp stuff.  A ballad about being eaten by lions; &quot;It&apos;s a family affair&quot;)</dd>
			<dd>{expand('ghost')} (Yes, new lp again.  They really went for this one, you know.  It was scary.)</dd>
			<dd>{expand('drugs')} (Now they&apos;re rockin&apos;)</dd>
			<dd>{expand('angels')} (Ha ha ha ha ha!  You Fools!  HA HA HA!!  HAHAHAHAHAHAHAHAHAHA!!!!!)</dd>
		...
		<blockquote>
			...
			for {expand('chick')} and I think &quot;Uh-oh&quot; so I ask him if he means
			that load of old bollocks about chickens in the bathroom,
			chickens on a stick sorta thing and he goes &quot;NAAAH, you
			PILLOCK! {expand('chick')}, the song.&quot; and I go &quot;Wot? That miserable
			...
			was {expand('walk')}, so I thought &quot;You can&apos;t play that, you haven&apos;t
