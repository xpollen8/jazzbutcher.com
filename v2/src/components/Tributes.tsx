...
export const TributeText = () => <div className="border"><Tag>Tributes In Words</Tag>  {texts.map(MakeSimpleURI)}</div>
export const TributeAudio = ()  => <div className="border"><Tag>Tributes In Song</Tag> {music.map(MakeSimpleURI)}</div>
