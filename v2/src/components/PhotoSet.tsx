...
const PhotoSet = ({ title, photos, description, credit, credit_url, credit_date }: { title: string, photos: any[], description?: string | React.ReactNode, credit_url?: string, credit_date?: string }) => <>
	<Tag> {title} </Tag>
