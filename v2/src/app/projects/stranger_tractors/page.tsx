...
<div className="listItem">
		<MyLink className="float-right ml-5 border drop-shadow-md w-52 bg-slate-50 text-center" href="/images/stranger_tractors/Tractor_curt.jpg">These were the Tractors<Image src="/images/stranger_tractors/Tractor_curt_250.jpg" width={250} height={250} alt="strangers" /> Curtis, Mr. Nasty, Bollie, Matt, and Mr. Shouty.  </MyLink>
...
<div className="listItem clear_float">
		<div className="float-right ml-5 border drop-shadow-md w-52 bg-slate-50 text-center">
		<MyLink href="/images/stranger_tractors/stranger_tractors.jpg"><Image src="/images/stranger_tractors/stranger_tractors.jpg" width={250} height={250} alt="album cover" /></MyLink>
		<MyLink href="/images/stranger_tractors/OP_curt.jpg"><Image src="/images/stranger_tractors/OP_curt_250.jpg" width={250} height={250} alt="album cover" /></MyLink>
		<MyLink href="/images/stranger_tractors/Tractorb_curt.jpg"><Image src="/images/stranger_tractors/Tractorb_curt_250.jpg" width={250} height={250} alt="album cover" /></MyLink>
		</div>
...
<p />
		<MyLink className="float-right ml-5 border drop-shadow-md w-52 bg-slate-50 text-center" href="/images/stranger_tractors/BEANKING.jpg"><Image src="/images/stranger_tractors/BEANKING.jpg" width={250} height={250} alt="the bean king" />{expand('curt')}</MyLink>
