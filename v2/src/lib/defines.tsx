...
const	people: HashedType = {
	...
	barker: { name: "David E. Barker", aliases: [ "david_barker", "Dave Barker", "Barker", "Lionel Brando" ], role: [ "producer", "artwork", "the reason for the season" ] },
	bd: { name: "Ben Davis" },
	beirne: { name: "Pat Beirne" },
	blair: { name: "Blair MacDonald" },
	aggi_demetri: { name: "Aggi Demetri" },
	botty: { name: "Ian Botterill", aliases: [ "Botty", "Bott", "Bot", "MC Bott", "MC Bot", "Mister B", "B-Man" ] },
	botty_bman: { name: "B-Man" },
	braind: { name: "Braindead Soundmachine", act: true },
	brent: { name: "Brent Bambury" },
	burrell: { name: "Tim Burrell", role: [ "engineer" ] },
	...
	kathy: { name: "Kathy Schaer", aliases: [ "Misery", "Special K", "Misery Wilson" ] },
	kathy_misery: { name: "Misery Wilson" },
	kevin: { name: "Kevin Komoda" },
	kizzy: { name: "Kizzy O'Callaghan", aliases: [ "Kizzy" ] },
	larry: { name: "Laurence O'Keefe", aliases: [ "Laurence" ] },
	...
	rev: { name: "Martin Stebbing", aliases: [ "Rev. Botus Whiteblood Fleming" ], role: [ "live soundman", "engineer", "producer" ] },
	richard: { name: "Richard Formby", aliases: [ "Richard" ], role: [ "guitars", "engineer" ] },
	rivers: { name: "John A. Rivers", role: [ "engineer", "producer" ] },
	...
	steve_gordon: { name: "Steve Gordon", aliases: [ "G-Man", "Stevie G" ] },
	...
	joe: { name:"Joe Foster", role: [ "guitar", "'93 live sound" ] },
...
//
	...
	howy: { name: "Howard Turner", role: [ "engineer" ] },
