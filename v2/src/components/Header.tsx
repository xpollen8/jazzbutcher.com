...
const sections : { [key: string]: BreadCrumb } = {
	...
	vaguely_familiar: { parent: 'project', title: 'Vaguely Familiar (1991)', inParentDirectory: true },
	cambodia: { parent: 'project', title: 'Cambodia (1991)', inParentDirectory: true },
	the_undertakers: { parent: 'project', title: 'The Undertakers (1995)', inParentDirectory: true },
	stranger_tractors: { parent: 'project', title: 'Stranger Tractors (1995)', inParentDirectory: true },
	alan_moore: { parent: 'project', title: 'Alan Moore', summary: 'Trampling Tokyo (2011)', inParentDirectory: true },
	drones_club: { parent: 'project', title: 'Drones Club (2014-2021)', inParentDirectory: true },
