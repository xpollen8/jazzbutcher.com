...
<>
	...
	<main className="etc">
		...
		<div className="flex mt-3 gap-5">
			<div>
				<Image alt="pills" src="https://v1.jazzbutcher.com/images/abcs_of_drugs/pills.gif" width={255} height={266} />
			</div>
			<div>
				...
				<div className="drugs_contents">
					...
					<Link href="/abcs_of_drugs/intro_groups">Drug groups</Link><br />
					<p />
					...
					<Link href="/abcs_of_drugs/tobacco">Tobacco/nicotine</Link><br />
					<br />
					<Link href="/abcs_of_drugs/law">Drugs and the law </Link><br />
					<Link href="/abcs_of_drugs/law_information">Sources of help and further information </Link><br />
				</div>
			</div>
		</div>
		</Drugs>
