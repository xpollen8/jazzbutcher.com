...
const Letter = () =>  {
	return ( <>
		...
		<main>
			...
			{expand('filth')}!
			<p />
			I have seen {expand('levit')} with their new American singer (whom
			they all appear to hate) - very powerful and strong,
			but rather pointless, in a very &quot;modern&quot; ways and {expand('strange')}
			- quite splendid!
			<p />
			Have succeeded in booking {expand('strange')} for the second annual
			...
			much! The guy came last year when we put on {expand('astor')} and
			...
			and, coup of coups!, a band from Vienna called {expand('eg')}.
			<p />
			...
			<p />
			On Friday night {expand('hend')} and I will be doing an acoustic
			show in Rugby.  The next proper JBC show is at La Maison
			Du Peuple (!) in Clermont-Ferrand, France, on 7th July.
			<p />
