...
<>
	<div className="annotation">
		...
		{personLink('max')}, {personLink('pat')} and Louis played three very small shows under
		...
		as Ramon Destine (with {personLink('max')} on guitar; it was Ramon who first uttered the words &quot;Take
		it, Max... &quot;), the Rockin&apos; Belgians and Terence Walpole,
		a deranged poet later to find recording fame with {personLink('eg')}.
		...
		The band lined up as: {personLink('pat')}: guitar and voice, The Antichrist:
		guitar and voice, {personLink('at')}: organ and voice, Chris &quot;Snogger&quot;
		Rudd (later of the Lost T-Shirts Of Atlantis) on bass,
		and {personLink('owen')} on drums.
		</p>
		<p>
